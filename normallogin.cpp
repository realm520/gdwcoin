    ...
    ui(new Ui::NormalLogin)
{
    ...
    connect( GDW::getInstance(),SIGNAL(jsonDataUpdated(QString)),this,SLOT(pwdConfirmed(QString)));
...
//        ui->tipLabel->setText( QString::fromLocal8Bit("密码至少为8位！") );
    ...
    GDW::getInstance()->postRPC( toJsonFormat( "id_unlock_normallogin", "unlock", QStringList() << "99999999" << ui->pwdLineEdit->text() ));
...
{
    qDebug() << GDW::getInstance()->closeToMinimize;
