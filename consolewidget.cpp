...
{
    delete ui;
    GDW::getInstance()->consoleWidget = NULL;
}
...
void ConsoleWidget::on_consoleLineEdit_returnPressed()
{
    ...
    if( ui->checkBox->isChecked())
    {
        ...
        GDW::getInstance()->postRPC( toJsonFormat( "console_" + str, command, paramaters ));
...
void ConsoleWidget::jsonDataUpdated(QString id)
{
    if( id.startsWith("console_"))
    {
        ...
        ui->consoleBrowser->append( GDW::getInstance()->jsonDataValue(id));
